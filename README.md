...
- [Tunnet](https://github.com/tunnetio/Tunnet) - Open-source private mesh networking with a self-hostable control plane, public tunnels, and identity SSH (QUIC/iroh).
